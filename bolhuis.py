...
simulation = D1.Bolhuis([0, 0, 1, 1, 1, 0])
target = D1.Bolhuis([0, 0, 1, 1, 1, 2])
...
boltzmann = np.exp(-target.potential(x_boltzmann)/(kb*T))
...
plt.title('underdamped ABOBA , Bolhuis system barrier height =2')
plt.grid()
